/atom/proc/investigate_log(message, subject)
	if(!message || !subject)
		return
	var/F = FILE_LOAD_PATH("[GLOB.log_directory]/[subject].html")
...
/client/proc/investigate_show()
	...
	for(var/subject in investigates)
		var/temp_file = FILE_LOAD_PATH("[GLOB.log_directory]/[subject].html")
	...
	var/F = FILE_LOAD_PATH("[GLOB.log_directory]/[selected].html")
	if(!fexists(F))
