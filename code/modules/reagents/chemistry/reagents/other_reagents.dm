...
/datum/reagent/semen/expose_turf(turf/open/exposed_turf, reac_volume)
	..()
	var/turf/open/T = exposed_turf
	if(!istype(T))
		return
	if(reac_volume < 10)
		return
...
/obj/effect/decal/cleanable/semen
	...
	icon = 'icons/obj/genitals/body_effects.dmi'
	icon_state = "semen1"
