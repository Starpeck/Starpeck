...
/obj/item/dildo/knotted
	dildo_shape 		= "knotted"
	name 				= "knotted dildo"
	attack_verb_continuous 		= list("penetrated", "knotted", "slapped", "inseminated")
	attack_verb_simple	= list("penetrated", "knotted", "slapped", "inseminated")

/obj/item/dildo/human
	dildo_shape 		= "human"
	name 				= "human dildo"
	attack_verb_continuous = list("penetrated", "slapped", "inseminated")
	attack_verb_simple = list("penetrated", "slapped", "inseminated")
...
/obj/item/dildo/flared
	dildo_shape 		= "flared"
	name 				= "flared dildo"
	attack_verb_continuous 		= list("penetrated", "slapped", "neighed", "gaped", "prolapsed", "inseminated")
	attack_verb_simple 		= list("penetrated", "slapped", "neighed", "gaped", "prolapsed", "inseminated")
